...
function constancias(){
 ...
 return `<div class="section-kicker">Constancias</div><h1 class="section-title">Busca tu participación</h1><p class="lead">Los botones quedarán listos para los PDF de constancias cuando se suban al repositorio.</p><div class="toolbar"><input value="${esc(filters.q)}" placeholder="Nombre, título o código…" oninput="filters.q=this.value;render()"></div>${cards(x.slice(0,120))}`;
}
